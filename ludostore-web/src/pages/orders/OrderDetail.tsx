...
const OrderDetail = () => {
  ...
  const handleCustomImageClick = (itemId: string, productName: string) => {
    setSelectedItem({ id: itemId, name: productName });
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {selectedOrder.items.map((item) => (
                      <div
                        key={item.id}
                        className="flex flex-col gap-3 py-3 border-b border-white/10 last:border-0 print:border-gray-200"
                      >
                        <div className="flex gap-3 sm:gap-4">
                          <div className="w-16 h-16 bg-[#2a2a2a] rounded-lg overflow-hidden shrink-0 print:border print:border-gray-200">
                            <img
                        ...
                        {canCustomize && (
                          <div className="flex justify-end">
                            <button
                              ...
                              className="flex items-center gap-2 px-3 py-1.5 bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-500 rounded-lg text-sm transition-colors cursor-pointer"
                            >
